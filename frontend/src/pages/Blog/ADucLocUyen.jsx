...
const ADucLocUyen = () => {
  ...
  const relatedPosts = [
    {
      id: 1,
      title: "Hành Trình Trại Lục Hòa VI Năm 2019 Tại Chùa Từ Hiếu",
      date: "15/03/2019",
      image: Img2,
      link: "/sinh-hoat/luc-hoa-vii-2024",
      description:
        "Ôn lại kỷ niệm đáng nhớ của trại Lục Hòa VI với những hoạt động ý nghĩa tại chùa Từ Hiếu.",
    },
    {
      id: 2,
      title: "Sinh Hoạt GĐPT Tây Thành Trong Năm 2023",
      date: "20/12/2023",
      image: Img5,
      link: "/sinh-hoat/sinh-hoat-2023",
      description:
        "Tổng hợp các sinh hoạt nổi bật của đơn vị GĐPT Tây Thành trong năm qua.",
    },
    {
      id: 3,
      title: "Lễ Hội Phật Giáo Tại Chùa Sơn Tùng Năm 2024",
      date: "10/01/2024",
      image: Img3,
      link: "/sinh-hoat/le-hoi-2024",
      description:
        "Khám phá không khí lễ hội đặc sắc tại chùa Sơn Tùng đầu năm 2024.",
    },
  ];
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 font-sans min-h-screen">
      ...
      {/* Kết bài */}
      <div className="text-gray-700 leading-relaxed mt-10 bg-white p-6 rounded-lg shadow-md">
